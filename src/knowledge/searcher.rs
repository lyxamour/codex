...
use crate::knowledge::base::CodeElement;
...
impl CodeSearcher {
    /// 创建新的代码搜索引擎实例
    pub fn new(indexer: std::sync::Arc<std::sync::RwLock<crate::knowledge::indexer::CodeIndexer>>) -> Self
    {
        Self {
            indexer,
        }
    ...
    /// 搜索特定类型的代码元素
    pub fn search_by_type(&self, query: &str, element_type: &crate::knowledge::base::CodeElementType) -> AppResult<Vec<CodeElement>>
    {
