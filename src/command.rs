...
impl BuiltinCommand {
    ...
    pub fn new(
        ...
        aliases: Vec<&str>,
        handler: Arc<
            dyn Fn(&[&str], &CommandContext) -> Result<String, Box<dyn Error>> + Sync + Send,
        >,
    ) -> Self {
        Self {
            name: name.to_string(),
...
impl CommandHandler for BuiltinCommand {
    ...
    async fn execute(
        ...
        println!(
            "Executing built-in command: {} with args: {:?}",
            self.name, args
        );
...
impl ExternalCommand {
    ...
    pub fn new(name: &str, description: &str, command_path: &str) -> Self {
        Self {
            name: name.to_string(),
            description: description.to_string(),
...
impl CommandRegistry {
    ...
    pub fn register_external(&mut self, name: &str, description: &str, command_path: &str) {
    ...
    fn register_builtin_commands(&mut self) {
        ...
        self.register_builtin(
            ...
            "exit",
            vec!["quit", "q"],
            Arc::new(|_args, _context| Ok("Exiting application...".to_string())),
        );
        ...
        self.register_builtin(
            ...
            "clear",
            vec!["cls"],
            Arc::new(|_args, _context| Ok("Screen cleared".to_string())),
        );
        ...
        self.register_builtin(
            ...
            vec!["cfg"],
            Arc::new(|args, _context| Ok(format!("Config command with args: {:?}", args))),
        );
        ...
        self.register_builtin(
            ...
            vec!["al"],
            Arc::new(|args, _context| Ok(format!("Alias command with args: {:?}", args))),
        );
        ...
        self.register_builtin(
            ...
            vec!["hk"],
            Arc::new(|args, _context| Ok(format!("Hook command with args: {:?}", args))),
        );
        ...
        self.register_builtin(
            ...
            vec!["sa"],
            Arc::new(|args, _context| Ok(format!("Subagent command with args: {:?}", args))),
        );
    }
...
impl CommandExecutor {
    ...
    pub async fn execute(&self, command_line: &str) -> Result<CommandResult, Box<dyn Error>> {
        ...
        self.registry
            .execute(command_name, &args_ref, &self.context)
            .await
    }
